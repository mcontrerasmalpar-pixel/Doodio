...
Doodio started as a Figma Make prototype for the **Figma Make Challenge**. After that, Maria continued the changes herself in this GitHub repo. It is not an ongoing Figma Make or Figma MCP design-to-code sync.
...
| Figma Make | Initial prototype only |
| Vercel | Deployment |
